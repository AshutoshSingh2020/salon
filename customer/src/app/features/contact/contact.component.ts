  ...
  template: `
    <section class="hero">
      <div>
        ...
        <p>Tell us what you need. Our team responds quickly during working hours.</p>
      </div>
      <div class="card">
        <h3>Salon Hours</h3>
        <p>Mon - Sat: 10:00 AM - 8:00 PM</p>
        <p>Sunday: Closed</p>
        <p class="muted">Support: +91 99999 99999</p>
      </div>
    </section>
    ...
    <section class="form-wrap">
      ...
      <div class="side">
        <h3>Visit Us</h3>
        <p class="muted">Walk-ins are welcome. For priority service, book in advance.</p>
        <div class="box">
          <strong>Salonify Studio</strong>
          <span>21 MG Road, Bengaluru</span>
          <span>India</span>
        </div>
      </div>
    </section>
